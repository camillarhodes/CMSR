...
# THERMAL_IMAGES_CONF.input_path = os.path.dirname(__file__) + '/Maagad4'
THERMAL_IMAGES_CONF.img_ext = 'jpg'
...
# THERMAL_IMAGES_CONF.back_projection_iters = [10, 10]
...
THERMAL_IMAGES_CONF.learning_rate_cpab_ratio = 20.0
THERMAL_IMAGES_CONF.learning_rate_affine_ratio = 50.0
THERMAL_IMAGES_CONF.learning_rate_tps_ratio = 0.01
