...
THERMAL_IMAGES_CONF.input_path = os.path.dirname(__file__) + '/data_processed/current4'
THERMAL_IMAGES_CONF.img_ext = 'png'
THERMAL_IMAGES_CONF.guiding_img_ext = 'png'
THERMAL_IMAGES_CONF.scale_factors = [[2.0, 2.0], [4.0, 4.0], [8.0, 8.0]]  # list of pairs (vertical, horizontal) for gradual increments in resolution
# THERMAL_IMAGES_CONF.scale_factors = [[4.0, 4.0]]  # list of pairs (vertical, horizontal) for gradual increments in resolution
THERMAL_IMAGES_CONF.back_projection_iters = [6, 6, 6]
THERMAL_IMAGES_CONF.base_change_sfs = [[2.0, 2.0], [4.0, 4.0]]  # list of pairs (vertical, horizontal) for gradual increments in resolution
...
DEPTH_MAPS_CONF.learning_rate_tps_ratio = 0.25
