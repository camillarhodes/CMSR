...
THERMAL_IMAGES_CONF.input_path = os.path.dirname(__file__) + '/E541/try1/single/downscaled/'
THERMAL_IMAGES_CONF.img_ext = 'tiff'
THERMAL_IMAGES_CONF.guiding_img_ext = 'png'
THERMAL_IMAGES_CONF.scale_factors = [[2.0, 2.0]]  # list of pairs (vertical, horizontal) for gradual increments in resolution
...
THERMAL_IMAGES_CONF.learning_rate_tps_ratio = 0.2
...
THERMAL_IMAGES_CONF.input_vmin = 1720 # empirically from maagad data
THERMAL_IMAGES_CONF.input_vmax = 5157 # empirically from maagad data
